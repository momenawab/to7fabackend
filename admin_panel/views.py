...
# Support Contact Management - Import from separate file
from .support_contact_views import support_contacts, support_contact_detail, update_contact_status, send_typing_indicator

# Legacy function for backward compatibility - redirects to new contact system
@admin_required('support_tickets') 
def support_tickets(request):
    """Redirect to new contact system"""
    return redirect('admin_panel:support_contacts')
